...
\graphicspath{{./LabeledImages/}{./OtherPlots/}{./ReportImages/}{./CorrectedImages/}}
...
\begin{enumerate}
    \item \textbf{Non-ideal Geometry}: The test article featured slightly blunted edges rather than the perfectly sharp corners assumed in theory. This causes the shock waves and expansion fans to form differently than predicted.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{OtherPlots/CdvM_AoA0}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{OtherPlots/CdvM_AoA3}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{OtherPlots/CdvM_AoA7}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{OtherPlots/CdvM_TheoryvsMeas}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{OtherPlots/dragpolar_theoryvmeas}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{OtherPlots/Xcp_TheorvMeas}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{OtherPlots/Ycp_TheorvMeas}
...
\begin{enumerate}
    \item The non-ideal geometry of the test article affecting shock and expansion fan locations
