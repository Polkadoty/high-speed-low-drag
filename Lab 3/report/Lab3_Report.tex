...
\textbf{Abstract} This experiment intends to compare experimental data gathered from supersonic flow over a diamond airfoil to that of shock-expansion theory. Our findings show discrepancies from theory as the expansions and recompression shocks occurred much more upstream with our test model.

\pagebreak

\section{Introduction}
%Relate to historic and current work based on references, plus what this report is about
Much of the work with diamond airfoils appear on the subject of supersonic speeds.
\vspace{2.5mm}

This report details experimental findings of supersonic flow over a diamond airfoil from Machs $2.0$-$3.0$ at different angles of attack $0\degree, 3\degree, 7\degree$. Flow visualizations and data gathered from the experiment is then compared to that of shock expansion theory to observe how well this experiment satisfies theory.
...
\begin{enumerate}
    \item Jernel, Lloyd  S. “Comparisons of Two-Dimensional Shock-Expansion Theory with Experimental Aerodynamic Data for Delta-Planform Wings at High Supersonic Speeds.” NTRS - NASA Technical Reports Server, June 1, 1974. \url{https://ntrs.nasa.gov/citations/19740018331}. 
    ...
    \item Wood, Richard M. “Supersonic Aerodynamics of Delta Wings.” NTRS - NASA Technical Reports Server, March 1, 1988. \url{https://ntrs.nasa.gov/citations/19880008231}. 
    \item Serafini, John S. “Impingement of Water Droplets on Wedges and Diamond Airfoils at Supersonic Speeds.” NTRS - NASA Technical Reports Server, July 1, 1953.\url{https://ntrs.nasa.gov/citations/19930083634}. 
\end{enumerate}
