...
$$
\begin{aligned}
\text{Stagnation Pressure Term} &= \frac{\partial M}{\partial P_0}\Delta P_0 \, (\text{not computed})\\
\text{Static Pressure Term} &= \frac{\partial M}{\partial P}\Delta P\, (\text{not computed})
\end{aligned}
$$
...
\begin{table}[H]
    ...
    \hline
    \textbf{Angle of Attack} & \textbf{M = 2.0} &\textbf{M = 2.25} & \textbf{M = 2.50} & \textbf{M = 3.0} \\[2mm]
    \hline
    $\alpha = 0\degree$ & $2.039$ & $2.343$ & $2.531$ & $2.960$ \\[2mm]
    \hline
    $\alpha = 3\degree$ & $2.046$ & $2.340$ & $2.534$ & $2.960$ \\[2mm]
    \hline
    $\alpha = 7\degree$ & $2.041$ & $2.332$ & $2.532$ & $2.965$ \\[2mm]
    \hline  
    \end{tabular}
    \caption{True Mach}
    \label{truemach}
...
Significant measurement uncertainties affected the calculated aerodynamic coefficients. Future experiments could benefit from sharper-edged test articles, more precise pressure measurements, and additional instrumentation for boundary layer characterization.
\vspace{2mm}
